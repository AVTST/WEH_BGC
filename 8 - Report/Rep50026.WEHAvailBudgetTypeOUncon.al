report 50026 "WEH_Avail. Budget Type O Uncon"
{
    DefaultLayout = RDLC;
    RDLCLayout = '8 - Report/Rep50026.WEHAvailBudgetTypeOUncon.rdl';
    PreviewMode = PrintLayout;
    Caption = 'Available Budget Type O';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Budget Name", "G/L Account No.", "Global Dimension 1 Code") WHERE("WEH_Budget Type" = FILTER(O));
            ...
            begin
                ...
                Clear(GLAcc);
                GLAcc.Get("G/L Budget Entry"."G/L Account No.");

                if not GLAcc."WEH_Non-confidential Account" then
                    CurrReport.Skip();
                ...
                //Group Header
                CLEAR(CurrGroup);
                CurrGroup := "Budget Name" + "G/L Account No." + "Global Dimension 1 Code";
                IF OldGroup <> CurrGroup THEN BEGIN
                    ...
                    AVGLBudgetEntry.SetRange("WEH_Budget Type", AVGLBudgetEntry."WEH_Budget Type"::O);
                    ...
                    AVGLBudgetEncPRPOTB.SetRange("Budget Type", AVGLBudgetEncPRPOTB."Budget Type"::O);
                    ...
                    AvailableBudget := AVBudgetAmount - AVPRAmount - AVPOAmount - AVActualAmount;
                    //Group Header
                END;
                OldGroup := CurrGroup;
            end;
