page 50095 "WEH_Purch. Quote Sub - Corp."
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("AVFN_G/L_Temp"; "AVFN_G/L_Temp")
                {
                    ApplicationArea = Suite;
                }
                ...
                field("AVF_WHT Product Posting Group"; "AVF_WHT Product Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                }
                ...
                field("Line Amount"; "Line Amount")
                {
                    ApplicationArea = Suite;
                    BlankZero = true;
                    Editable = false; //NOT IsBlankNumber; AVTST
                    Enabled = NOT IsBlankNumber;
                ...
                field("AVTD_Ref. Doc. No."; "AVTD_Ref. Doc. No.")
                {
                    ApplicationArea = suit;
                    Editable = false;
                }
                field("AVTD_Ref. Line No."; "AVTD_Ref. Line No.")
                {
                    ApplicationArea = suit;
                    Editable = false;
                }
    ...
    begin
        ...
        GLSetup.Get();
        "WEH_Budget Name" := GLSetup."WEH_Active Budget";
    end;
