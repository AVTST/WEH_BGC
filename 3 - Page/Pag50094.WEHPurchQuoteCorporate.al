page 50094 "WEH_Purch. Quote - Corporate"
{
    Caption = 'Purchase Quote - Corporate';
    PageType = Document;
    PromotedActionCategories = 'Check Budget,Process,Report,Approve,Request Approval,Print/Send,Quote,Release,Navigate';
    RefreshOnActivate = true;
    SourceTable = "Purchase Header";
    SourceTableView = WHERE("Document Type" = FILTER(Quote), "WEH_Finish PR" = const(false));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "WEH_Purch. Quote Sub - Corp.")
            {
                ApplicationArea = Suite;
        ...
        area(factboxes)
        {
            ...
            part(WorkflowStatus; "Workflow Status FactBox")
            {
                ...
                Enabled = false;
                ShowFilter = false;
                Visible = false; //ShowWorkflowStatus; Zine 21/12/2020
            }
            ...
            group(Action92)
            {
                ...
                action("Report Selections")
                {
                    ...
                    begin
                        ...
                        ReportSelectTB.SetRange(ReportSelectTB.Usage, ReportSelectTB.Usage::"P.Quote");
                        Clear(I);
            ...
            group("F&unctions")
            {
                ...
                action("WEH_Check Available Budget")
                {
                    ...
                    begin
                        ...
                        BudgetControlMgt.CheckBudget(Rec);
                    end;
                }
                action("WEH_Uncheck Budget")
                {
                    ApplicationArea = All;
                    Caption = 'Uncheck Budget';
                    Image = Undo;
                    Promoted = true;
                    PromotedIsBig = true;
                    ...
                    begin
                        CLEAR(BudgetControlMgt);
                        BudgetControlMgt.UnCheckBudget(Rec);
                    end;
                }
            }
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    var
                        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
                    begin
                        TestField("WEH_Check Budget", "WEH_Check Budget"::Pass);
    ...
    begin
        Editabled := "WEH_Check Budget" <> "WEH_Check Budget"::Pass;
