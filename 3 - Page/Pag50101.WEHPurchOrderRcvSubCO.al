page 50101 "WEH_Purch. Order Rcv. Sub. CO"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("WEH_Amount (LCY)"; "WEH_Amount (LCY)")
                {
                    ApplicationArea = Suite;
                    Editable = false;
                }
                field("WEH_Amount Incl. VAT (LCY)"; "WEH_Amount Incl. VAT (LCY)")
                {
                    ApplicationArea = Suite;
                    Editable = false;
                }
