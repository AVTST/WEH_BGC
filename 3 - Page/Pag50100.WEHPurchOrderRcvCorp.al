page 50100 "WEH_Purch. Order Rcv. Corp."
{
    Caption = 'Purchase Order (Recevied)';
    PageType = Document;
    ...
    SourceTableView = WHERE("Document Type" = FILTER(Order), Status = const(Released), AVTD_FINISHED = const(false));
    InsertAllowed = false;
    ModifyAllowed = true;
    DeleteAllowed = false;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("WEH_Receive Date"; "WEH_Receive Date")
                {
                    ApplicationArea = Suite;
                    Style = Unfavorable;
                }
            ...
            part(PurchLines; "WEH_Purch. Order Rcv. Sub. CO")
            {
                ApplicationArea = Suite;
        ...
        area(processing)
        {
            ...
            group("P&osting")
            {
                ...
                action(Post)
                {
                    ...
                    trigger OnAction()
                    begin
                        Rec.TestField("WEH_Receive Date");
