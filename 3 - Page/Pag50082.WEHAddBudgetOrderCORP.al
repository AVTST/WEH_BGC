page 50082 "WEH_Add Budget Order CORP"
{
    Caption = 'Add Budget Order - Corporate';
    PageType = Document;
    ApplicationArea = All;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Pending Approvals"; "Pending Approvals")
                {
                    ...
                    begin
                        ...
                        ApprovalEntry.SetRange("Document Type", ApprovalEntry."Document Type"::"Add Budget Order - Corp.");
            ...
            part(BudgetCorpLines; "WEH_Add Budget Subform CORP")
            {
                Editable = PageEditabled;
    ...
    actions
    {
        area(Reporting)
        {
            action("Add Budget Request")
            {
                ...
                begin
                    CurrPage.SetSelectionFilter(AddBudgetHead);
                    Report.RunModal(Report::"WEH_Add Budget Request", true, false, AddBudgetHead);
                end;
            }
        }
        area(Processing)
    ...
    begin
        "Document Type" := "Document Type"::"Add Budget";
        SetPageEditabled();
    end;
