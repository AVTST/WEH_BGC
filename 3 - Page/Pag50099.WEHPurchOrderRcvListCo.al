page 50099 "WEH_Purch. Order Rcv. List Co"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Purchase Orders (Received)';
    CardPageID = "WEH_Purch. Order Rcv. Corp.";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Order), Status = const(Released), AVTD_FINISHED = const(false));
    UsageCategory = Lists;
